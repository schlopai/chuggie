...
| <img src="polyglot/de.png" width="480"> | **[polyglot](polyglot/README.md)**<br>`polyglot` | One merchant screen, four languages, and a layout that survives all of them. |
...
| <img src="visual-novel/talk.png" width="480"> | **[visual-novel](visual-novel/README.md)**<br>`visual-novel` | A branching story on `packages/cutscene-core`: choices, portraits, and a flag set three scenes earlier being read back. |
